...
BIORELEX_RELATION_TYPES = [NOT_RELATION, 3, 0, 1]

DATASETS = [ADE, BIORELEX,ADE1,BIORELEX1]

# Model Save Path
BASE_SAVE_PATH = '/home/user/rxq/MVGNAS/saved_model' 
...
# UMLS_EMBS_SIZE = 25 # https://github.com/r-mal/umls-embeddings
# METAMAP_PATH = '/home/ubuntu/public_mm/bin/metamap20'      
