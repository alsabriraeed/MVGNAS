...
def filter_mentions(data, candidate_mentions, dataset):
    if dataset == ADE or dataset == ADE1: return filter_ade_mentions(data, candidate_mentions)
    if dataset == BIORELEX or dataset == BIORELEX1: return filter_biorelex_mentions(data, candidate_mentions)
