...
from utils.utils import vocab, constant, helper              

def parse_args():
    parser = argparse.ArgumentParser(description='Prepare vocab for relation extraction.')
    parser.add_argument('--data_dir',default='/content/drive/My Drive/ColabNotebooks/REGraphNAS/graphnas/dataset/semeval', help='TACRED directory.')
    parser.add_argument('--vocab_dir',default='/content/drive/My Drive/ColabNotebooks/REGraphNAS/graphnas/dataset/vocab', help='Output vocab directory.')
    parser.add_argument('--glove_dir', default='/content/drive/My Drive/ColabNotebooks/My_GraphNas/graphnas/data/glove.6B', help='GloVe directory.')             
    parser.add_argument('--wv_file', default='glove.6B.300d.txt', help='GloVe vector file.')                           
